...
print(f"Matches per front at recommended threshold:")
for col in df2.columns[1:]:
...
print("="*70)
print(f"Goal: 20-40% coverage (20-40 lineages matched per front)\n")
...
print(f"Current Similarity Distribution (non-zero only):")
